        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 items-center">
          ...
          <div>
            ...
            >
              ...
              <span className="text-teal italic"> entidad</span> al siguiente
              nivel
            </motion.h2>
          ...
          >
            {submitted ? (
              <div className="rounded-2xl border border-teal/20 bg-teal-soft p-10 text-center">
                <div className="mx-auto mb-4 inline-flex items-center justify-center w-14 h-14 rounded-full bg-teal/10">
                  <CheckCircle size={28} className="text-teal" />
                </div>
                <h3 className="text-[1.25rem] font-bold text-navy mb-2">
                  Solicitud recibida
                </h3>
                <p className="text-[0.9375rem] text-gray-500 leading-relaxed">
                  Nuestro equipo te contactará en las próximas 24 horas hábiles
                  para agendar la demo.
                </p>
              </div>
            ) : (
              <form
                onSubmit={handleSubmit}
                className="rounded-2xl border border-border bg-white p-8 md:p-10 shadow-sm"
              >
                <h3 className="text-[1.125rem] font-bold text-navy mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="form-input"
                      placeholder="Ej: Secretario(a) de Hacienda"
                    />
                  </div>
                ...
                <p className="mt-4 text-[0.6875rem] text-gray-400 leading-relaxed text-center">
                  ...
                  tratamiento de datos personales conforme a la Ley 1581 de
                  2012.
                </p>
              </form>
            )}
