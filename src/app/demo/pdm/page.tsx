...
import { ArrowLeft, MapPin, ClipboardList } from "lucide-react";
import GobiaLogo from "@/components/illustrations/GobiaLogo";

const PDMDashboard = dynamic(() => import("@/components/dashboard/PDMDashboard"), {
  loading: () => (
      ...
      <main className="mx-auto max-w-[1200px] px-5 md:px-8 py-10 md:py-16">
        ...
        >
          ...
          <p className="text-[0.9375rem] leading-relaxed text-gray-500 max-w-2xl">
            Seguimiento en tiempo real de las líneas estratégicas, metas de resultado
            e indicadores del Plan de Desarrollo 2024-2027 de Medellín. Datos reales
            de TerriData (DNP).
          </p>
        </motion.div>
