...
const RendicionDashboard = dynamic(() => import("@/components/dashboard/RendicionDashboard"), {
  loading: () => (
      ...
      <main className="mx-auto max-w-[1200px] px-5 md:px-8 py-10 md:py-16">
        ...
        >
          ...
          <p className="text-[0.9375rem] leading-relaxed text-gray-500 max-w-2xl">
            Control centralizado de todos los reportes obligatorios del municipio:
            FUT, CHIP, SIA, SIRECI, SECOP, SPI y más. Estado de cumplimiento en
            tiempo real con calendario de vencimientos.
          </p>
        </motion.div>
